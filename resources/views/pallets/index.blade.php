                                ...
                                <div class="panel panel-success">
                                    <div class="panel-heading">
                                        ...
                                        <input type="hidden" name="prueba" id="prueba_{{ $indexKey }}" value="{{ $item->number }}">
                                            ...
                                            <a href="{{ route('palletitems.create', $item->number) }}" class="btn btn-xs btn-info pull-right" data-toggle="modal" data-target="#addPalletItem" data-toggle="tooltip" data-placement="top" title="Agregar item de paleta"><i class="fas fa-plus-circle"></i> Agregar</a>
