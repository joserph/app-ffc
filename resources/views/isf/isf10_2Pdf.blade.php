...
<body>
    <table>
        ...
        <tr>
            ...
            <td class="medium-letter text-left border-arriba">SOUTH AMERICAN GLOBAL SHIPPING AND TRANSPORT</td>
        </tr>
        <tr>
            <td class="medium-letter text-left border-arriba-abajo">741 SAN PEDRO ST</td>
        </tr>
        <tr>
            <td class="medium-letter text-left border-arriba-abajo">LOS ANGELES, CA 90014</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="medium-letter text-left border-arriba-abajo">FRESH LOGISTICS CARGA CIA.LTDA</td>
            <td class="medium-letter text-left border-arriba-abajo">741 SAN PEDRO ST</td>
        </tr>
        <tr>
            <td class="medium-letter text-left border-arriba-abajo">NICOLAS BAQUERO N17 Y 29 DE ABRIL. CENTRO LOGÍSTICO ALPACHACA</td>
            <td class="medium-letter text-left border-arriba-abajo">LOS ANGELES, CA 90014</td>
        </tr>
        <tr>
            <td class="medium-letter text-left border-arriba-abajo">QUITO ECUADOR</td>
